...
bool CHelpJson::load(const LanguageManager& a_lang, bool a_bOnlyResource, const tstring& a_sUrl)
{
	return CBaseJson::load(GetInstructionFileNameFromLangID(a_lang, a_sUrl), IDR_JSON_INSTRUCTIONS, GetModuleHandle(NULL), a_bOnlyResource);
}



tstring CHelpJson::GetInstructionFileNameFromLangID(const LanguageManager& a_lang, const tstring& a_sUrl)
{

	tstring l_sDefaultUrl = a_sUrl + c_sDefaultInstructions;
	...
	// Zbuduj nazwê pliku
	return a_sUrl + tstring(l_sName) + c_sInstructionsSuffix;
}