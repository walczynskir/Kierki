...
inline static void OnInitDialog(HWND a_hDlg, RRegData::RPlayersRegData* a_pData);
...
static RRegData::RPlayersRegData* GetRData(HWND a_hDlg);
inline static void GetCtrlValues(HWND a_hDlg);

#define MAX_NAME (128)


HWND CreateOptPlayerDlg(HWND a_hParent, RRegData::RBaseRegData* a_pData, LPVOID a_pObj)
{
...
static void OnInitDialog(HWND a_hDlg, RRegData::RPlayersRegData* a_pData)
{
...
static INT_PTR CALLBACK OptionsPlayerDlgProc(HWND a_hDlg, UINT a_iMsg, WPARAM a_wParam, LPARAM a_lParam)
{
	...
	{
	case WM_INITDIALOG:
		OnInitDialog(a_hDlg, reinterpret_cast<RRegData::RPlayersRegData*>(a_lParam));
		return TRUE;
...
{
	RRegData::RPlayersRegData* l_pData = GetRData(a_hDlg);
...
static RRegData::RPlayersRegData* GetRData(HWND a_hDlg)
{
	...
	return reinterpret_cast<RRegData::RPlayersRegData*>(::GetWindowLong(a_hDlg, GWL_USERDATA));
